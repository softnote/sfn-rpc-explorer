...
function getAddressDetails(address, scriptPubkey, sort, limit, offset) {
	...
	return new Promise(async (resolve, reject) => {
		var mainnetUrl = `https://api.blockchair.com/softnote/dashboards/address/${address}/?offset=${offset}`;
		var testnetUrl = `https://api.blockchair.com/softnote/testnet/dashboards/address/${address}/?offset=${offset}`;
